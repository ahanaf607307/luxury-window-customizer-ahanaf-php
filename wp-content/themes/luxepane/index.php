    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-badge">
                <span>✨</span>
                <span><?php esc_html_e('Architectural Glass & Window Systems', 'luxepane'); ?></span>
            </div>

            <h1 class="hero-title">
                <?php esc_html_e('Engineering Elegance with', 'luxepane'); ?> 
                <span class="gold-text"><?php esc_html_e('Bespoke Glass & Windows', 'luxepane'); ?></span>
            </h1>

            <p class="hero-subtitle">
                <?php esc_html_e('Discover high-performance sliding glass windows, acoustic soundproof glazing, and luxury custom frames tailored for modern residences and commercial architecture.', 'luxepane'); ?>
            </p>

            <div class="hero-actions" style="margin-bottom: 2.5rem; display: flex; justify-content: center; gap: 1.2rem; flex-wrap: wrap;">
                <a href="<?php echo esc_url(home_url('/window-studio')); ?>" class="btn btn-primary" style="padding: 0.95rem 2rem; font-size: 1.05rem; font-weight: 700; border-radius: var(--radius-full);">
                    <span>✨ <?php esc_html_e('Launch Window Studio', 'luxepane'); ?></span>
                </a>
                <a href="<?php echo function_exists('wc_get_page_permalink') ? esc_url(wc_get_page_permalink('shop')) : esc_url(home_url('/shop')); ?>" class="btn btn-secondary" style="padding: 0.95rem 2rem; font-size: 1.05rem; font-weight: 700; border-radius: var(--radius-full);">
                    <span>🪟 <?php esc_html_e('Explore Window Catalog', 'luxepane'); ?></span>
                </a>
            </div>
